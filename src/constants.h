...
const double hBar2     = 1.11211999e-68;  // hBar^2 in J^2/s^2
const double hBar4     = 1.23681087e-136; // hBar^4 in J^4/s^4
...
const int empty_system                  =  6003; // geometry file contains no molecules/atoms
...
const int insufficient_MPI_size_for_PI  = 12000; // Path Integral "bead chains" require at least three systems
