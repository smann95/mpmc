...
// Take a vector in fractional coordinates (frac[]) and convert it to cartesian coordinates.
...
// Take a vector in cartesian coordinates (cart[]) and convert it to fractional coordinates.
